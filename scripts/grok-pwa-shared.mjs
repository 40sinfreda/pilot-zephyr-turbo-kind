...
export const DEFAULT_APP_NAME = "Tideline";
...
/**
 * This app is Tideline — do not derive the display name from the grok.me slug.
 */
...
export function grokPwaHeadTags(appName = DEFAULT_APP_NAME) {
  return [
    ...
    ["apple-touch-icon", '<link rel="apple-touch-icon" href="/tideline-icon.svg">'],
    [
    ...
    ["theme-color", '<meta name="theme-color" content="#06151c">'],
  ];
}
